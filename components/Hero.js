        ...
        <>
            <div className="h-[55vh] grid items-center justify-items-center bg-black border border-slate-700 relative rounded-md">
                <div className="grid items-center justify-items-center text-center opacity-100 z-[1700]">
                    ...
                    <button type="button" className="text-base sm:text-sm px-7 py-2 bg-gradient-to-br from-pink-600 to-violet-600 rounded-md shadow-lg shadow-rose-600 active:scale-90 hover:translate-y-2 transition-all">View Collection</button>
                </div>
